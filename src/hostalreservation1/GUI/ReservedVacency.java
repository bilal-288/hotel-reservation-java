...
import hostalreservation1.Listner.SaveReservedVacencyListner;
...
public class ReservedVacency {
  ...
  String sfname,slname,scnic,sage,saddress,sphone,sreligion,snationality,sgander; 
   public ReservedVacency(){
       ...
       panel1.setBounds(0, 200, 1370, 1000);
       ...
       c.gridy++;
       panel1.add(save,c);
       save.addActionListener(new SaveReservedVacencyListner(fram, field_fname,field_lname,field_Age,field_Address,field_num,field_cnic,field_Religion,field_Nationality,field_Gander ));
